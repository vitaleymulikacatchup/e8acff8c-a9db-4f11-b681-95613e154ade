...
export const metadata: Metadata = {
  title: "Zaporizhzhya - Discover Ukraine's Jewel",
  description: "Explore Zaporizhzhya, Ukraine's most captivating city. Visit historic Khortytsia Island, scenic Dnieper River, museums, and cultural attractions.",
  keywords: "Zaporizhzhya, Ukraine, travel guide, attractions, Khortytsia, Dnieper River, city guide",
  openGraph: {
    title: "Zaporizhzhya - The Jewel of Ukraine",
    description: "Discover the beauty, history, and culture of Zaporizhzhya. Explore legendary attractions and unforgettable experiences.",
    siteName: "Zaporizhzhya City Guide",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Zaporizhzhya - Ukraine's Most Captivating City",
    description: "Explore history, culture, and natural beauty in Zaporizhzhya"
  }
};
